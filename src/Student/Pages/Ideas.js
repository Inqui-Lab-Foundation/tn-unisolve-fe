...
import { DropDownComp } from '../../stories/DropdownComp/DropdownComp.jsx';
              ...
              <Col>
                <h1 className="mb-4">Register your idea</h1>
                        ...
                        <Row className="register-block mt-5">
                            <Col>
                                <h5 className="mb-5">
                                    Bring out your Innovative solution for the
                                    problem selected
                                </h5>
                                <Form onSubmit={formik.handleSubmit}>
                                    ...
                                    >
                                        ...
                                        <Form.Label>Idea Title</Form.Label>
                                        <p>
                                            Be specific and imaging you’re
