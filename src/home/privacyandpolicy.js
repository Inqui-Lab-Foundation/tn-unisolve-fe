...
const Home = () => {
    ...
    const accordion = [
        ...
        },
        {
            ...
            desc: 'Open the website and click register. Register your school/Institution thereby entering the Teacher Unique Code/Unique ID and then filling in all required details. Once the registration process is completed, you can log in to your account either by entering a password or with OTP.'
        },
        {
            id: 5,
                        ...
                        <Row className="h-100">
                            <Col xs={12} md={10} lg={4} className="center">
                                <h1>
                                    ...
                                    Creating change makers of tomorrow with{' '}
                                    <span>21st Century</span> Skills
                ...
                <Container className="both">
                    <Row>
                        ...
                        >
                            <h2 className="mb-5">
                                What is
                                <span className="blue"> UPSHIFT</span>?
                            </h2>
                            <p>
                                UPSHIFT is a UNICEF global innovation for
                                transferable skills building of adolescents and
                                young people that is now in implementation in 45
                                countries. UPSHIFT is designed to build
                                transferable skills and create opportunity, with
                                a focus on the young people. UPSHIFT supports
                                the development of skills for life and
                                livelihood and supports youth to positively
                                engage with their local communities as
                                change-makers. [Learn more about ]
                            </p>
                            <p>
                                With the goal of engaging and skilling more
                                adolescents and young people, UNICEF, along with
                                State Government, Yuwaah and Inqui-Lab
                                Foundation embarked on the development of
                                UNISOLVE.
                            </p>
                            <Link
                                className="landing-page-actions"
                    ...
                    <Row className="student">
                        ...
                        >
                            ...
                            <p>
                                UNISOLVE is a digital platform designed to
                                facilitate UPSHIFT delivery through a
                                school-based, teacher-facilitated blended
                                learning model.
                            </p>
                            <p>
                                UNISOLVE combines the advantages of distance
                                learning opportunities and face-to-face
                                activities to promote creativity and innovation
                                among adolescents and young people. Designed
                                with and for the education system keeping
                                scalability in mind this specially designed
                                platform, UNISOLVE, is a tool to skill students
                                on social innovation and 21st century skills.
                            </p>
                            <Link
                                className="landing-page-actions"
                                exact="true"
